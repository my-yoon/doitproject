...
.noticebox{display:flex;justify-content: space-between; border:1px solid #ddd; border-radius: 20px;}
.noticebox .newsitem{flex:1; padding:30px 30px 53px 30px}
.noticebox .newsitem +.newsitem{margin-left:20px;border-left:solid 1px #ddd}
.noticebox .newsitem strong{display:block; font-size:18px; color:#222}
.noticebox .newsitem span{display:block; font-size:16px; color:#676767}
